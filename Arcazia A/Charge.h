...
/**
    ...
    \file       Charge.h
    \brief      Implementation of Charge class
...
public:
    ...
    **/ /** @{ ******************************************************************/
    ...
    //Charge(const Charge& rhs_) = delete;

    /// \brief      Move constructor
    //Charge(Charge&& rhs_) = delete;
    ...
    **/ /** @{ ******************************************************************/
    ...
    //Charge& operator=(const Charge& rhs_) = delete;

    /// \brief      Move operator, use default implementation
    //Charge& operator=(Charge&& rhs_) = delete;
